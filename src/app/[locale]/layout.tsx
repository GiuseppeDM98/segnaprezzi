...
/*
 * Dual theme-color strategy (Spec 06 §3): the manifest carries a single
 * theme_color, but the browser chrome has to follow the user's color scheme.
 * Next renders these as two <meta name="theme-color" media="…"> tags, and
 * the manifest value applies only where those are absent (splash screens).
 * WARNING: these are the sRGB conversion of the `background` token in
 * globals.css — see the checklist in src/app/manifest.ts.
 */
...
export async function generateMetadata({
  ...
  return {
    ...
    // Generated by `pnpm icons` from docs/assets/logo.svg (Spec 06 §4).
    icons: {
      icon: [
